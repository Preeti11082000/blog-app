...
// Uses DETERMINISTIC fixed IDs (matching Atlas blogdb) so that /api/blogs and /api/blogs/[id]
// return consistent IDs even though each serverless function has isolated memory.
// Previously used random ObjectId() per invocation → IDs differed per function → 404 on detail.

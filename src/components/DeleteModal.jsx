  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl max-w-md w-full p-6 shadow-xl">
        ...
        <h3 className="text-lg font-bold">Delete Blog?</h3>
        <p className="text-sm text-slate-600 mt-2 leading-relaxed">Are you sure you want to delete <span className="font-semibold text-slate-900">"{title}"</span>? This action cannot be undone.</p>
